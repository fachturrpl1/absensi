...
const cspHeader = isDev ? '' : `
  ...
  img-src 'self' blob: data: https://*.supabase.co https://*.supabase.in https://*.tile.openstreetmap.org https://unpkg.com https://cdn.jsdelivr.net https://upload.wikimedia.org;
  font-src 'self' data:;
  object-src 'none';
  base-uri 'self';
  form-action 'self';
