    ...
    useEffect(() => {
        if (initialData && isOpen) {
            setFormData({
                ...
                // Map delivery
                sendEmail: initialData.sendEmail || initialData.deliveryChannels?.email || false,
                sendSlack: initialData.sendSlack || initialData.deliveryChannels?.slack || false,
                showHighlights: initialData.showHighlights || initialData.deliveryChannels?.highlights || true,
            })
        }
    }, [initialData, isOpen])
        ...
        >
            ...
            >
                <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    <h2 className="text-xl font-semibold text-gray-900">Edit smart notification</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <p className="text-xs text-gray-400 italic">Weekly notifications will consider the average of the metric across the week</p>
