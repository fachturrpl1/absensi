            ...
            <div className="flex flex-1 w-full overflow-hidden">
                ...
                <div className="flex-1 p-4 md:p-8 overflow-y-auto w-full">
                    ...
                    <p className="text-sm text-slate-500 mb-8 max-w-2xl leading-relaxed">
                        Allow tasks/to-dos to be managed (create, edit, delete) by <span className="text-slate-900 font-semibold">everyone</span> (role: users) or <span className="text-slate-900 font-semibold">management only</span> (roles: org owner and org managers)
                    </p>
