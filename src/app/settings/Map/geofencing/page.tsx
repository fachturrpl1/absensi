...
import { Calendar, Info, MapPin, Loader2, Trash2, Maximize } from "lucide-react"
                    ...
                    <div className="max-w-5xl space-y-8">
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                            ...
                            <div className="space-y-6">
                                {/* Mini Map */}
                                <div className="h-[300px] w-full bg-white rounded-lg border border-slate-200 overflow-hidden shadow-inner">
                                    <GeofenceMap 
