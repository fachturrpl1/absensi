...
import { Users, Info, Search, User, CheckSquare } from "lucide-react"
...
export default function ProductivityChampPage() {
    ...
    const sidebarItems = [
        ...
        { label: "Productivity champ", href: "/settings/Achievements/productivity-champ", active: true },
            ...
            <div className="flex flex-1">
                ...
                <div className="flex-1 p-6">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold text-gray-900">Productivity champ</h4>
                    ...
                    <div className="flex items-center gap-3 mb-10">
                        <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                            ...
                            />
                            <span className="px-3 py-2 bg-gray-100 text-sm text-gray-600 border-l border-gray-300">to-dos</span>
                        </div>
                        <Button
                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-3 py-3 border-b border-gray-200">
                            ...
                            <span className="text-sm font-semibold text-gray-900">Productivity champ</span>
                            <span className="text-sm font-semibold text-gray-900">Weekly to-dos goal</span>
                        </div>
