            ...
            <div className="flex flex-1 w-full overflow-hidden">
                ...
                <div className="flex-1 p-4 md:p-6 w-full overflow-x-hidden">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-6 mb-8 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        ...
                        <div>
                            <h4 className="text-base font-bold text-slate-900">Time hero</h4>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-12">
                        <div className="flex items-center bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm focus-within:ring-1 focus-within:ring-slate-400 transition-all w-full sm:w-fit">
                            <Input
                                ...
                                className="w-full sm:w-24 border-0 text-center font-bold text-slate-900 h-10 focus-visible:ring-0"
                            />
                            <span className="px-4 py-2 bg-slate-50 text-[10px] font-bold text-slate-500 border-l border-slate-200 uppercase tracking-widest">hours</span>
                        </div>
                        <Button
                            onClick={handleApplyToAll}
                            className="px-8 bg-slate-900 text-white hover:bg-slate-800 h-10 rounded-xl font-bold transition-all active:scale-95 shadow-lg shadow-slate-100 w-full sm:w-auto"
                        >
                    ...
                    <div className="mt-6">
                        ...
                        <div className="hidden sm:grid grid-cols-3 py-3 border-b border-gray-200">
                            ...
                            <span className="text-sm font-semibold text-gray-900">Time hero</span>
                            <span className="text-sm font-semibold text-gray-900">Weekly hours goal</span>
                        </div>
