...
import { FileText, Upload, X, HelpCircle, Download } from "lucide-react"
...
export default function MembersImportSimplePage() {
  ...
  const handleFileSelect = async (selectedFile: File) => {
    ...
    // Store file in sessionStorage for mapping page using base64
    try {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="w-full px-6 pt-0">
        {/* Sub-navigation/Action Bar - Direct at top, no margin */}
        ...
        <div className="flex flex-col items-center justify-center min-h-[500px] pt-16 mt-8">
            {/* Document Icon with Purple Circle */}
            ...
            {/* Drop Zone */}
            <div
              className={`w-full max-w-2xl p-12 transition-colors ${
                isDragActive
                  ? "bg-primary/5"
                  : ""
              }`}
