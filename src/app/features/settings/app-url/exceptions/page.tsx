...
export default function TeamExceptionsPage() {
    const tabs: SettingTab[] = [
        { label: "APP/URL", href: "/features/settings/app-url", active: true },
    ]

    const sidebarItems: SidebarItem[] = [
        { id: "classification", label: "Classification", href: "/features/settings/app-url" },
        { id: "exceptions", label: "Team exceptions", href: "/features/settings/app-url/exceptions" },
    ]
