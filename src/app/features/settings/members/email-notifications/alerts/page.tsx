...
export default function AlertRulesPage() {
    ...
    const tabs: SettingTab[] = [
        { label: "EMAIL NOTIFICATIONS", href: '/features/settings/members/email-notifications', active: true },
    ...
    const sidebarItems: SidebarItem[] = [
        { id: "email-notifications", label: "Email notifications", href: "/features/settings/members/email-notifications" },
        { id: "templates", label: "Email templates", href: "/features/settings/members/email-notifications/templates" },
        { id: "alerts", label: "Alert rules", href: "/features/settings/members/email-notifications/alerts" },
    ]
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="flex items-center gap-3">
                            <Button
                                ...
                                onClick={() => window.location.href='/features/settings/members/email-notifications/templates'}
                            >
