...
import { Info, Search, CheckSquare, Loader2, Trophy } from "lucide-react"
...
export default function ProductivityChampPage() {
    ...
    const getMemberGoal = (memberId: string) => {
        return memberSettings[memberId]?.goal ?? globalWeeklyTodosGoal
    }
    ...
    const tabs: SettingTab[] = [
        ...
        { label: "ACHIEVEMENTS", href: "/features/settings/Achievements", active: true },
    ]

    const sidebarItems = [
        { id: "efficiency-pro", label: "Efficiency pro", href: "/features/settings/Achievements" },
        { id: "productivity-champ", label: "Productivity champ", href: "/features/settings/Achievements/productivity-champ" },
        { id: "time-hero", label: "Time hero", href: "/features/settings/Achievements/time-hero" },
    ]
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <SettingsContentLayout sidebarItems={sidebarItems} activeItemId="productivity-champ">
                {/* Section Title */}
