...
export default function ReasonsPage() {
    ...
    const tabs: SettingTab[] = [
        ...
        { label: "TIMESHEETS", href: "/features/settings/timesheets", active: true },
    ...
    const sidebarItems: SidebarItem[] = [
        { id: "modify-time", label: "Modify time (manual time)", href: "/features/settings/timesheets" },
        { id: "require-reason", label: "Require reason", href: "/features/settings/timesheets/require-reason" },
        { id: "reasons", label: "Reasons", href: "/features/settings/timesheets/reasons" },
    ]
