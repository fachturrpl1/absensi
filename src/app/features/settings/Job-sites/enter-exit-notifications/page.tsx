...
const SETTING_KEY = "enter_exit_notifications"
...
export default function EnterExitNotificationsPage() {
        ...
        const loadData = async () => {
            ...
            try {
                ...
                if (globalRes.success && globalRes.data) {
                    // Default to true if not set yet (standard app behavior for notifications)
                    currentGlobalEnabled = globalRes.data[SETTING_KEY] !== false
    ...
    const handleGlobalChange = async (enabled: boolean) => {
        ...
        if (!res.success) {
            ...
            toast.success("Global notification setting updated")
        }
    }
    ...
    const tabs: SettingTab[] = [
        { label: "CALENDAR", href: "/features/settings/Calender", active: false },
        { label: "JOB SITES", href: "/features/settings/Job-sites", active: true },
        { label: "MAP", href: "/features/settings/Map", active: false },
    ]

    const sidebarItems: SidebarItem[] = [
        { id: "restrict-timer", label: "Restrict timer to job sites", href: "/features/settings/Job-sites" },
        { id: "enter-exit-notifications", label: "Enter/exit notifications", href: "/features/settings/Job-sites/enter-exit-notifications" },
    ]
