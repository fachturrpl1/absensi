...
export default function ScreenshotSettingsPage() {
  ...
  const tabs: SettingTab[] = [
    ...
    { label: "SCREENSHOTS", href: "/features/settings/screenshot", active: true },
  ]

  const sidebarItems: SidebarItem[] = [
    { id: "frequency", label: "Screenshot frequency", href: "/features/settings/screenshot" },
    { id: "blur", label: "Screenshot blur", href: "/features/settings/screenshot/blur" },
    { id: "delete", label: "Delete screenshots", href: "/features/settings/screenshot/delete" },
  ]
