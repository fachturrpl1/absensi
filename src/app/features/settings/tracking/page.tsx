...
export default function TrackingPage() {
    ...
    const tabs: SettingTab[] = [
        { label: "ACTIVITY", href: "/features/settings/activity", active: false },
        { label: "TIMESHEETS", href: "/features/settings/timesheets", active: false },
        { label: "TRACKING", href: "/features/settings/tracking", active: true },
        { label: "SCREENSHOTS", href: "/features/settings/screenshot", active: false },
    ]

    const sidebarItems: SidebarItem[] = [
        { id: "keep-idle-time", label: "Keep idle time", href: "/features/settings/tracking" },
        { id: "idle-timeout", label: "Idle timeout", href: "/features/settings/tracking/idle-timeout" },
        { id: "allowed-apps", label: "Allowed apps", href: "/features/settings/tracking/allowed-apps", icon: Star },
    ]
