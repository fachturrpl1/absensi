...
export default function ShiftAlertsPage() {
    ...
    const sidebarItems: SidebarItem[] = [
        { id: "calendar-type", label: "Calendar type", href: "/features/settings/Schedule" },
        { id: "shift-alerts", label: "Shift alerts", href: "/features/settings/Schedule/shift-alerts" },
        { id: "grace-period", label: "Grace period", href: "/features/settings/Schedule/grace-period" },
    ]
    ...
    const tabs: SettingTab[] = [
        { label: "CALENDAR", href: "/features/settings/Calender", active: true },
        { label: "SCHEDULE", href: "/features/settings/Schedule", active: false },
        { label: "JOB SITES", href: "/features/settings/Job-sites", active: false },
