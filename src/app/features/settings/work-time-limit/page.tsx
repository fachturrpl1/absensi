...
export default function WorkTimeLimitPage() {
    ...
    const tabs: SettingTab[] = [
        ...
        { label: "WORK TIME LIMITS", href: "/features/settings/work-time-limit", active: true },
    ...
    const sidebarItems: SidebarItem[] = [
        { id: "work-time-limit", label: "Work time limit", href: "/features/settings/work-time-limit" },
        { id: "idle-detection", label: "Idle detection", href: "/features/settings/work-time-limit/idle-detection" },
    ]
