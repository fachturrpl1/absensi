...
export default function OvertimePage() {
    ...
    const sidebarItems: SidebarItem[] = [
        { id: "overtime", label: "Overtime policies", href: '/features/settings/Policies/overtime' },
        { id: "time-off", label: "Policies", href: '/features/settings/Policies' },
        { id: "balances", label: "Balances", href: '/features/settings/Policies/time-off-balances' },
        { id: "holidays", label: "Holidays", href: '/features/settings/Policies/holidays' },
    ]

    const tabs: SettingTab[] = [
        { label: "TIME OFF", href: "/features/settings/Policies", active: false },
        { label: "WORK BREAKS", href: "/features/settings/Policies/work-breaks", active: false },
        { label: "OVERTIME", href: "/features/settings/Policies/overtime", active: true },
    ]
