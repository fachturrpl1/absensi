...
export default function WorkBreaksPage() {
    ...
    const tabs: SettingTab[] = [
        ...
        { label: "WORK BREAKS", href: "/features/settings/Policies/work-breaks", active: true },
        { label: "OVERTIME", href: "/features/settings/Policies/overtime", active: false },
    ]

    const sidebarItems: SidebarItem[] = [
        { id: "policies", label: "break policies", href: "/features/settings/Policies/work-breaks" },
        { id: "notifications", label: "break notifications", href: "/features/settings/Policies/work-breaks/notifications" },
    ]
