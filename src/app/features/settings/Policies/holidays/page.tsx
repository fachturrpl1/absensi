...
export default function HolidaysPage() {
    ...
    const tabs: SettingTab[] = [
        ...
        { label: "OVERTIME", href: "/features/settings/Policies/overtime", active: false },
    ]

    const sidebarItems: SidebarItem[] = [
        { id: "policies", label: "Time off policies", href: "/features/settings/Policies" },
        { id: "holidays", label: "Holidays", href: "/features/settings/Policies/holidays" },
        { id: "balances", label: "Time off balances", href: "/features/settings/Policies/time-off-balances" },
    ]
