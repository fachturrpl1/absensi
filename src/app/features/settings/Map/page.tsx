...
export default function MapPage() {
    ...
    const tabs: SettingTab[] = [
        ...
        { label: "MAP", href: "/features/settings/Map", active: true },
    ]

    const sidebarItems: SidebarItem[] = [
        { id: "track-locations", label: "Track locations", href: "/features/settings/Map" },
        { id: "geofencing", label: "Geofencing", href: "/features/settings/Map/geofencing" },
        { id: "schedule", label: "Tracking schedule", href: "/features/settings/Map/schedule" },
    ]
