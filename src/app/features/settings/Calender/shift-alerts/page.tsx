...
export default function ShiftAlertsPage() {
    ...
    const sidebarItems: SidebarItem[] = [
        { id: "calendar-type", label: "Calendar type", href: "/features/settings/Calender" },
        { id: "shift-alerts", label: "Shift alerts", href: "/features/settings/Calender/shift-alerts" },
        { id: "grace-period", label: "Grace period", href: "/features/settings/Calender/grace-period" },
    ]
