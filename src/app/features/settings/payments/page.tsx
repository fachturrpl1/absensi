...
export default function PaymentsPage() {
  ...
  const tabs: SettingTab[] = [
    ...
    { label: "PAYMENTS", href: "/features/settings/payments", active: true },
  ...
  const sidebarItems: SidebarItem[] = [
    { id: "payments", label: "Payments", href: "/features/settings/payments" },
    { id: "billing-history", label: "Billing history", href: "/features/settings/payments/billing-history" },
  ]
