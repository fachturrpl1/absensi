  ...
  const settingsCards: SettingsCardProps[] = [
    {
      ...
      icon: Building2,
      items: [
        { label: 'Projects & taks', href: '/features/settings/project-management' },
      ],
    },
    {
      title: 'Members',
      icon: Users,
      items: [
        { label: 'E-mail notifications', href: '/features/settings/members/email-notifications' },
        { label: 'Work time limits', href: '/features/settings/work-time-limit' },
        { label: 'Payments', href: '/features/settings/payments' },
        { label: 'Achievements', href: '/features/settings/Achievements' },
        { label: 'Custom fields', href: '/features/settings/custom-fields' },
      ],
    },
    {
      title: 'Schedules',
      icon: Calendar,
      items: [
        { label: 'Calendar', href: '/features/settings/Calender' },
        { label: 'Job sites', href: '/features/settings/Job-sites' },
        { label: 'Map', href: '/features/settings/Map' },
      ],
    },
    {
      ...
      icon: Activity,
      items: [
        { label: 'Activity', href: '/features/settings/Activity/track-apps-urls' },
        { label: 'Timesheets', href: '/features/settings/timesheets' },
        { label: 'Time & tracking', href: '/features/settings/tracking/allowed-apps' },
        { label: 'Screenshots', href: '/features/settings/screenshot' },
      ],
    },
    {
      title: 'Insights',
      ...
      badge: 'Add-on',
      items: [
        { label: 'Apps/URLs classifications', href: '/features/settings/app-url' },
      ],
    },
    {
      title: 'Policies',
      icon: FileText,
      items: [
        { label: 'Time off', href: '/features/settings/Policies' },
        { label: 'Breaks', href: '/features/settings/Policies/work-breaks' },
        { label: 'Overtime', href: '/features/settings/Policies/overtime' },
      ],
    },
  ];
