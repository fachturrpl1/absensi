            ...
            <div className="flex flex-1">
                ...
                <div className="flex-1 p-6">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold text-gray-900">Time hero</h4>
                            <p className="text-sm text-gray-500">Reach the goal for total hours worked each week</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mb-10">
                        <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                            ...
                            />
                            <span className="px-3 py-2 bg-gray-100 text-sm text-gray-600 border-l border-gray-300">hours</span>
                        </div>
                        <Button
