...
export default function NewOrganizationPageFix() {
  ...
  const loadInitialData = async () => {
    try {
      ...
      // Set timezones (getAvailableTimezones returns Promise<string[]>)
      ...
      // Set roles with fallback if empty
      if (rolesList && Array.isArray(rolesList) && rolesList.length > 0) {
        ...
        const firstFallback = fallbackRoles[0]
        if (firstFallback) {
          setFormData(prev => ({
            ...prev,
            defaultRoleId: firstFallback.id
          }))
        }
      }
    } catch (err) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.data) {
        // Invalidate all dashboard and data queries
                  ...
                  <div className="grid gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="orgName" className={fieldErrors.orgName ? 'text-red-500' : ''}>Organization Name *</Label>
                        <Input
                          id="orgName"
                      ...
                      {/* Organization Code */}
                      <div className="space-y-2">
                        <Label htmlFor="orgCode" className={fieldErrors.orgCode ? 'text-red-500' : ''}>Organization Code *</Label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {/* Phone */}
                      <div className="space-y-2">
                        <Label htmlFor="phone" className={fieldErrors.phone ? 'text-red-500' : ''}>Phone Number</Label>
                        <Input
                          id="phone"
                          type="tel"
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select value={formData.stateProvince} onValueChange={handleStateChange} disabled={isSubmitting || !locationData || isLoadingData}>
                        ...
                        <div className="space-y-2">
                          ...
                          <Select value={formData.city} onValueChange={handleCityChange} disabled={isSubmitting || availableCities.length === 0}>
                        ...
                        <div className="space-y-2">
                          ...
                          <Select value={formData.postalCode} onValueChange={(value) => setFormData(prev => ({ ...prev, postalCode: value }))} disabled={isSubmitting || availablePostalCodes.length === 0}>
